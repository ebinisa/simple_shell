 ...
 * @info: This is the parameter struct
 *
 * Return: histcount on success, but returns 0 otherwise
 */
 ...
 * @info: This the structure containing potential arguments
 * Used to maintain
 * @buf: buffer
...
/**
 * renumber_history - This renumbers the history linked list
 * after changes
