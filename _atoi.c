 ...
 * @info: struct address
 *
 * Return: 1 if in interactive mode, otherwise, it returns 0
 */
 ...
 * Return: This returns 1 if true, otherwise returns 0 if false
 */
 ...
 * Return: This returns 1 if c is alphabetic, otherwise returns 0 if false
 */
