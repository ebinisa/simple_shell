...
/**
 * struct passinfo - This contains pseudo-arguments to pass
 * into a function,
 ...
 * @path: Ths is a string path for the current command
...
/**
 * struct builtin - This contains a builtin string and
 * related function
